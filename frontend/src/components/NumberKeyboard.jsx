...
const NumberKeyboard = ({ onNumberClick, onDelete, onSubmit, disabled }) => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white/70 backdrop-blur-xl border-t border-white/30 shadow-2xl p-2 sm:p-3 pb-[env(safe-area-inset-bottom)] z-50 xl:hidden">
