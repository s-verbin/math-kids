...
import { LogOut, LogIn, UserPlus, Trophy, Home, Sprout } from 'lucide-react';
        ...
        <div className="flex items-center justify-between min-h-[44px]">
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            ...
            {user ? (
              ...
              <>
                <Link to="/login" className="flex items-center gap-1 sm:gap-2 px-2 sm:px-3 py-2 rounded-xl bg-purple-600 text-white active:bg-purple-700 transition touch-manipulation min-h-[44px]">
                  <LogIn size={18} className="sm:w-5 sm:h-5" />
                  <span className="text-sm">Войти</span>
                </Link>
                
                <Link to="/register" className="flex items-center gap-1 sm:gap-2 px-2 sm:px-3 py-2 rounded-xl bg-pink-600 text-white active:bg-pink-700 transition touch-manipulation min-h-[44px]">
