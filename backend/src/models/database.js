...
const farmItems = [
  ...
  { name: 'Автосборщик ресурсов', category: 'upgrade', price: 1000, description: 'Автоматически собирает готовые ресурсы' },
  { name: 'Инкубатор', category: 'upgrade', price: 300, description: 'Куры несут яйца на 30% быстрее' },
  { name: 'Доильный аппарат', category: 'upgrade', price: 500, description: 'Коровы дают молоко на 40% быстрее' },
  { name: 'Стригальная машина', category: 'upgrade', price: 400, description: 'Овцы дают шерсть на 50% быстрее' },
